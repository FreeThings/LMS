    ...
    public class StudentController : Controller
    {
        ...
        public IActionResult GetMyClasses(string uid)
        {
            var query = from c in db.Classes
                ...
                join d in db.Departments on co.Departments equals d.Abbreviation
        ...
        {            
            ...
            //     join co in db.Courses on c.Course equals co.CourseId
            //     where co.Departments == subject && co.Number == num && c.Season == season && c.Year == year
            //     select c.ClassId;
            // var assignmentQuery = from c in classQuery
            //     join ac in db.AssignmentCategories on c equals ac.Class
            ...
            //         score = s.Score
            //     };
            // return Json(assignmentQuery);
            
            var query = from c in db.Classes
                join co in db.Courses on c.Course equals co.CourseId
                where co.Departments == subject && co.Number == num
                                            && c.Season == season && c.Year == year
                join ac in db.AssignmentCategories on c.ClassId equals ac.Class
                join a in db.Assignments on ac.CategoryId equals a.Category
                join s in db.Submissions.Where(s => s.Student == uid) on a.AssignmentId equals s.Assignment into submissions
          ...
          string category, string asgname, string uid, string contents)
        {
            ...
            var existing = db.Submissions.FirstOrDefault(s => s.Assignment == assignment.AssignmentId && s.Student == uid);
        ...
        {          
            ...
            {
                Class = classQuery.FirstOrDefault(),
                Student = uid,
                Grade = "--"
            });
            try
        ...
        {            
            var gradesQuery = from e in db.Enrolleds
            ...
            {
                if (gradeToPoints.ContainsKey(grade))
                {
